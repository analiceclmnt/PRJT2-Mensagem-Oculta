...
function criptografar(){
    ...
    var resultCripto = texto.replace(/e/g,"enter").replace(/i/g, "saes").replace(/a/g, "ai")
...
function descriptografar(){
    ...
    var resultDescripto = texto.replace(/enter/g,"e").replace(/saes/g,"i").replace(/ai/g,"a")
